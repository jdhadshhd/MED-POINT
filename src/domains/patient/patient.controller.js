...
const patientController = {
  ...
  /**
   * GET /patient/diet-plan/view - View diet plan as HTML (for printing)
   */
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .print-btn { position: fixed; top: 20px; right: 20px; background: #28a745; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; font-size: 14px; }
...
<body>
  ...
  <div class="footer">
    ...
    <p>Date: ${new Date().toLocaleDateString()}</p>
      ...
      console.error('[Patient] View diet plan error:', error);
      res.status(500).send('<h1>Failed to load diet plan</h1>');
    }
  },
};
